...
import { p as propTypes } from './common/hoist-non-react-statics.cjs-2ee5b6bc.js';
import { c as connect, R as ReactReduxContext } from './common/index-0f43782e.js';
import { m as matchPath, R as Router } from './common/react-router-bf471a5a.js';
...
import './common/history-1cc80428.js';

var lodash_isequalwith = createCommonjsModule(function (module, exports) {
/**
...
var createSelectors = function createSelectors(structure) {
  ...
  var isRouter = function isRouter(value) {
    return value != null && _typeof$1(value) === 'object' && getIn(value, ['location']) && getIn(value, ['action']);
  };
  ...
  var ConnectedRouter = /*#__PURE__*/function (_PureComponent) {
    ...
    function ConnectedRouter(props) {
      ...
      _this.unsubscribe = store.subscribe(function () {
        ...
        if (isTimeTravelDebuggingAllowed && props.history.action === 'PUSH' && (pathnameInHistory !== pathnameInStore || searchInHistory !== searchInStore || hashInHistory !== hashInStore || !lodash_isequalwith(stateInStore, stateInHistory, stateCompareFunction))) {
...
var ConnectedRouter = /*#__PURE__*/createConnectedRouter(structure);
var connectRouter = /*#__PURE__*/createConnectRouter(structure);

export { ConnectedRouter, connectRouter, routerMiddleware };
